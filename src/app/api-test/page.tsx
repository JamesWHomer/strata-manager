    ...
    <div className="min-h-screen flex flex-col">
      ...
      <header className="bg-blue-700 text-white shadow-md">
        <div className="container mx-auto px-4 py-4 flex justify-between items-center">
          ...
          <nav className="hidden md:flex space-x-6">
            ...
            <Link href="/api-test" className="hover:underline font-medium">API Test</Link>
          </nav>
        </div>
      </header>
      ...
      <main className="flex-grow">
        <div className="container mx-auto px-4 py-8">
          ...
          <div className="mt-8">
            <h3 className="text-lg font-semibold mb-3">Other Serverless Functions</h3>
            <p className="mb-4">The following functions are automated and triggered by cron jobs:</p>
            <ul className="list-disc pl-5 space-y-2">
              <li><strong>Nightly Report</strong> - Runs every night at midnight to generate building activity reports.</li>
              <li><strong>Monthly Levy Reminder</strong> - Runs at 9 AM on the first day of each month to send payment reminders.</li>
            </ul>
          </div>
        </div>
      </main>
